...
namespace Tesseract
{
    ...
    public struct PixColor : IEquatable<PixColor>
    {
        ...
        public static PixColor FromRgba(uint value) => new(
               (byte)((value >> 24) & 0xFF),
               (byte)((value >> 16) & 0xFF),
               (byte)((value >> 8) & 0xFF),
               (byte)(value & 0xFF));

        public static PixColor FromRgb(uint value) => new(
               (byte)((value >> 24) & 0xFF),
               (byte)((value >> 16) & 0xFF),
               (byte)((value >> 8) & 0xFF),
               0xFF);

        public uint ToRGBA() => (uint)((Red << 24) |
               (Green << 16) |
               (Blue << 8) |
               Alpha);
        ...
        public override bool Equals(object obj) => (obj is PixColor color) && Equals(color);
